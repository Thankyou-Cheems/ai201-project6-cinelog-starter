...
The fixture and assertion style follows tests/test_collection.py.
"""
...
def test_add_to_watchlist_creates_entry(app, sample_user, sample_film):
    """Adding a valid film creates and persists one watchlist entry."""
    with app.app_context():
...
def test_add_to_watchlist_duplicate_raises(app, sample_user, sample_film):
    """Adding the same film twice raises instead of creating a duplicate."""
    with app.app_context():
...
def test_add_to_watchlist_nonexistent_film_raises(app, sample_user):
    """A missing film raises the service's explicit not-found error."""
    with app.app_context():
